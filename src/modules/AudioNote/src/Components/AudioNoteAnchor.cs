        ...
        public void UpdateVisualState(AudioNoteAnchorVisual current)
        {
            switch (current)
            {
                case AudioNoteAnchorVisual.Grabbed:
                    this.iconMaterial.Material = this.assetsService.Load<Material>(AudioNoteResourceIDs.Materials.AnchorGrabbed);
                    break;
                case AudioNoteAnchorVisual.Selected:
                    this.iconMaterial.Material = this.assetsService.Load<Material>(AudioNoteResourceIDs.Materials.AnchorIdle);
                    this.backMaterial.Material = this.assetsService.Load<Material>(AudioNoteResourceIDs.Materials.AnchorSelected);
                    break;
                default:
                    this.iconMaterial.Material = this.assetsService.Load<Material>(AudioNoteResourceIDs.Materials.AnchorIdle);
                    this.backMaterial.Material = this.assetsService.Load<Material>(AudioNoteResourceIDs.Materials.AudioNoteAnchorBack);
                    break;
            }
        }
